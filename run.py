...
def get_args():
    ...
    parser.add_argument('--tokenizer_path', default='chn_gpt/vocab.txt', type=str, required=False, help='词表路径')
    parser.add_argument('--model_config', default='chn_gpt/config.json', type=str, required=False,
                        help='模型参数路径')
    parser.add_argument('--model_path', default='chn_gpt/pytorch_model.bin', type=str, required=False, help='模型路径')

    parser.add_argument("--seed", type=int, default=0)
    parser.add_argument("--lm_model", type=str, default="gpt-2-chn", help="gpt-2 or gpt-neo")
    parser.add_argument("--clip_checkpoints", type=str, default="./clip_checkpoints", help="path to CLIP")
    parser.add_argument("--target_seq_length", type=int, default=20)
    parser.add_argument("--cond_text", type=str, default="图片的内容是")
